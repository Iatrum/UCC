...
export default function ScanICPageV1() {
  return (
  ...
  const runOCR = async () => {
    if (!captured) {
      toast({
        ...
        description: "Take a photo of the IC before reading.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      toast({
        title: "OCR error",
        description: error.message || "Failed to read IC",
        variant: "destructive",
      });
    } finally {
      setIsReading(false);
          ...
          <div className="relative aspect-video w-full overflow-hidden rounded-md bg-black/20">
            ...
            {captured && (
              <div className="absolute inset-0 bg-black/70">
                <NextImage src={captured} alt="Captured IC" fill className="rounded object-contain" sizes="100vw" />
              </div>
            )}
