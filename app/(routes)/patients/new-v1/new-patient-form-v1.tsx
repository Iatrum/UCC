...
const RequiredLabel = ({ children }: { children: React.ReactNode }) => (
  <FormLabel className='after:content-["*"] after:ml-0.5 after:text-red-500'>{children}</FormLabel>
);

interface NewPatientFormV1Props {
  initialFullName?: string;
  initialNric?: string;
  initialVisitIntent?: "consultation" | "otc" | "follow_up";
}

export default function NewPatientFormV1({
  initialFullName = "",
  initialNric = "",
  ...
  async function onSubmit(data: PatientFormValues) {
    try {
      ...
      const dateOfBirthIso = dateOfBirthObj.toISOString().split("T")[0];
      ...
      const result = await savePatientThroughIntakePilot(patientData);
